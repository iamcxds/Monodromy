				...
				$elm$core$List$concat(
					_List_fromArray(
						[
							...
							$elm$core$List$map,
							function (a) {
								return _Utils_Tuple2(a, $author$project$Tools$GameObject$blackTile);
							},
							obstacle.blocks),
							_List_fromArray(
							[
...
var $author$project$Tools$GameObject$controls = function (_int) {
	switch (_int) {
		case 38:
...
var $author$project$Tools$GameObject$onKeyDown = function (keyControl) {
	return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Tools$GameObject$onKeyDown($author$project$Tools$GameObject$controls)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Tools$GameObject$myLevels = _List_fromArray(
	[
		{
		gP: A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$JumpTo(
							$author$project$Main$Play(level)))
					]),
				_List_fromArray(
					[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Select the scene')
						])),
					A2(
					$elm$html$Html$ul,
					_List_fromArray(
